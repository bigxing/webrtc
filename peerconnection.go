...
func (pc *PeerConnection) AddTransceiverFromKind(kind RTPCodecType, init ...RtpTransceiverInit) (*RTPTransceiver, error) {
	...
	case RTPTransceiverDirectionSendrecv:
		// TODO Sean-Der if no codecs
		track, err := NewTrackLocalStaticSample(pc.api.mediaEngine.videoCodecs[0].RTPCodecCapability, util.MathRandAlpha(16), util.MathRandAlpha(16))
		if err != nil {
			return nil, err
		}
